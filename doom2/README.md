...
The information here reflects the requirements of the legacy Doom engines only. The UDMF, USDF, or ZSDF map formats have different requirements.
...
* [[DECALDEF]] ''Used to define and animate [[decal]]s.''
* [[DECORATE]] ''Used to create new things from scratch.''
* [[DEFBINDS]] ''Sets default key binds.''
* [[DeHackEd|DEHACKED]] ''For modifying existing [[vanilla Doom]] things.''
...
* [[FraggleScript|FSGLOBAL]] ''Global FraggleScript lump.''
